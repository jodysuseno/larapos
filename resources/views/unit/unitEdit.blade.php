...
<div class="row">
  <div class="col-md-6">
    <form method="post" action="{{ route('unit.update', $unit->unit_id) }}">
      @method('patch')
      @csrf
      <div class="tile">
        <div class="tile-body">
          <div class="form-group">
            ...
            <input class="form-control @error('name') is-invalid @enderror" value="{{ old('name', $unit->name) }}" name="name" type="text">
            @error('name')
