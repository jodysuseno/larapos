...
<body class="app sidebar-mini">
  ...
  <script>
    // var nextform = 0;
    // // tambah isian form
    // function funcPilih(a, b, c, d) {
    //   nextform++;
    //   $("#insert-form").append(
    //     '<tr id="row' + nextform + '">' +
    //     '<td></td>' +
    //     '<td><input class="form-control input_custom" type="text" name="kd_brg[]" id="kd_brg' + nextform + '" readonly></td>' +
    //     '<td><input class="form-control input_custom" type="text" name="nm_brg[]" id="nm_brg' + nextform + '" readonly></td>' +
    //     '<td><input class=" input_custom" type="text" name="stok[]" id="stok_brg' + nextform + '" readonly></td>' +
    //     '<td><input class="countval" type="number" min="1" onchange="funcDistIn(' + nextform + ');" onkeyup="funcDistIn(' + nextform + ');" onkeypress="return event.charCode >= 48 && event.charCode <= 57" value="0" name="jumlah_trx[]" id="jumlah_trx' + nextform + '" ></td>' +
    //     // '<td><input class="form-control input_custom" type="text" name="sisa_stok[]" id="sisa_stok' + nextform + '" readonly></td>' +
    //     '<td id="sisa_stok' + nextform + '">0</td>' +
    //     '<td>' +
    //     '<button class="btn btn-danger btn-xs"  id="' + nextform + '"  >Hapus</button>' +
    //     '</td>' +
    //     '</tr>'

    //   );

    //   var kd_brg = document.getElementById("kd_brg" + nextform);
    //   var stok_brg = document.getElementById("stok_brg" + nextform);
    //   var nm_brg = document.getElementById("nm_brg" + nextform);
    //   // var sisa_stok = document.getElementById("sisa_stok" + nextform);
    //   var sisa_stok = document.getElementById("total");
    //   var jumlah_trx = document.getElementById("jumlah_trx" + nextform);

    //   kd_brg.setAttribute("value", a);
    //   stok_brg.setAttribute("value", c);
    //   nm_brg.setAttribute("value", b);
    //   sisa_stok.rows[c - 1].cells[5].setAttribute("innerHTML", c);
    //   jumlah_trx.setAttribute("max", c);
    //   jumlah_trx.setAttribute("value", 1);


    //   $("#jumlah-form").val(nextform);
    // }

    // function funcDistIn(a) {
    //   var stok_brg = document.getElementById("stok_brg" + a).value;
    //   var jml_brg = document.getElementById("jumlah_trx" + a).value;
    //   // var sisa_stok = document.getElementById("sisa_stok" + a).value;

    //   var count = parseInt(stok_brg) - parseInt(jml_brg);
    //   if (isNaN(count)) count = stok_brg;

    //   document.getElementById("sisa_stok" + a).innerHTML = count;

    //   // var table = document.getElementById("total"), sumHsl = 0;
    //   // for (var t = 1; t < table.rows.length; t++) {
    //   //   sumHsl = sumHsl + parseInt(table.rows[t].cells[5].innerHTML);
    //   // }
    //   // document.getElementById("valtotal").value = sumHsl;

    // }

    // function selectItem(itemCode, itemName, stok, price){
    //   document.getElementById("itemCode").innerHTML = "Kode Barang : "+itemCode;
    //   document.getElementById("itemName").innerHTML = "Nama Barang : "+itemName;
    //   document.getElementById("itemPrice").innerHTML = "Harga Barang : "+price;
    //   document.getElementById("itemStock").innerHTML = "Stok : "+stok;

    // }

    // function countRemainingStock(){
      
    // }

    // // function funcPilihPeg(pa, pb) {
    // //   var kd_pg = document.getElementById("kd_pg");
    // //   var nm_pg = document.getElementById("nm_pg");

    // //   kd_pg.setAttribute("value", pa);
    // //   nm_pg.setAttribute("value", pb);
    // // }
    ...
    //   document.getElementById("date_trx").value = (("0" + dt.getDate()).slice(-2)) + "/" + (("0" + (dt.getMonth() + 1)).slice(-2)) + "/" + (dt.getFullYear());
    // }
